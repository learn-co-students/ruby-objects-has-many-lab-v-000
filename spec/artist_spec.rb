...
puts describe "Artist" do
  ...
  let!(:adele) { Artist.new("Adele") }
    ...
    describe "#new" do 
      ...
      puts it "is initialized with an empty collection of songs" do
    ...
    puts describe "#add_song_by_name" do
    ...
    puts describe ".song_count" do
      ...
      puts it "uses the class variable, @@song_count" do
